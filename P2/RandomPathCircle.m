%RandomPathCircle Vehicle driver class
%
...
classdef RandomPathCircle < handle
    properties
        goal        % current goal
    ...
    methods
        ...
        function driver = RandomPathCircle(dim,x_goal,y_goal,varargin)
        ...
        function setgoal(driver)
          a=driver.dim*driver.randstream.rand(1);
          r=a;
          k=2*pi* driver.randstream.rand(1);
          driver.goal=[r*cos(k)+driver.x_0;r*sin(k)+driver.y_0];
        end
